...
function App() {
  // Declare an array with 11 players and their scores[cite: 4]
  const players = [
    { name: 'Jack', score: 50 },
  ...
  // Simple if else flag variable logic[cite: 4]
  var flag = false; // Change this to false to see the other output[cite: 4]
